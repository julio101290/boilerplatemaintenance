...
<div class="row">
    ...
    <div class="col-lg-2  col-xs-12 col-md-2">
        <div class="form-group">
            <label for="datetime"><?= lang('newOrderMaintenance.date') ?></label>
            <input type="date" id="date" name="date" value="<?= $fecha ?>">
        </div>
    </div>
    <div class="col-4" col-lg-12>
        <div class="form-group">
            <label for="idEmpresaSells"><?= lang('newOrderMaintenance.companie') ?> </label>
    ...
    <div class="col-lg-2  col-xs-12 col-md-2">
        <div class="form-group">
            <label for="idSucursal"><?= lang('newOrderMaintenance.branchoffice') ?> </label>
    ...
    <div class="col-lg-4  col-xs-12 col-md-4 pull-right" style="
         ...
         ">
        <div class="form-group ">
            <label for="codeSell"><?= lang('newOrderMaintenance.folio') ?></label>


            <input type="text" id="codeOrder" name="codeOrder" disabled value="<?= $folio ?>">
        </div>
    </div>
...
<div class="row comprobantesRD" hidden>
    ...
    <div class="col-6">
        <div class="form-group">
            <label for="tipoComprobanteRD"><?= lang('newOrderMaintenance.typeVoucher') ?> </label>
    ...
    <div class="col-6 pull-right" style="text-align: right;">
        <div class="form-group ">
            <label for="folioComprobanteRD"><?= lang('newOrderMaintenance.typeVoucher') ?></label>
...
<div class="row">
    ...
    <div class="col-lg-1  col-xs-12 col-md-1">
        <div class="form-group">
            <label for="datetime"><?= lang('newOrderMaintenance.expirationDate') ?></label>
