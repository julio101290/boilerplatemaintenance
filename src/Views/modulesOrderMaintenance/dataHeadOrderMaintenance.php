    ...
    <div class="col-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title"><?= lang('newOrderMaintenance.header') ?></h3>
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="generales-tab" data-toggle="tab" data-target="#generales" type="button" role="tab" aria-controls="generales" aria-selected="true"><?= lang('newOrderMaintenance.generals') ?></button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="profile-tab" data-toggle="tab" data-target="#otrosDatos" type="button" role="tab" aria-controls="otrosDatos" aria-selected="false"><?= lang('newOrderMaintenance.others') ?>
                        </button>
                    </li>
                    ...
                    <li class="nav-item" role="presentation" hidden>
                        <button class="nav-link" id="facturaGlobal-tab" data-toggle="tab" data-target="#facturaGlobal" type="button" role="tab" aria-controls="facturaGlobal" aria-selected="false">
                            <?= lang('newOrderMaintenance.globalInvoice') ?>
                        </button>
                    </li>
                    ...
                    <li class="nav-item" role="presentation" hidden>
                        <button class="nav-link" id="profile-tab" data-toggle="tab" data-target="#facturacionMX" type="button" role="tab" aria-controls="facturacionMX" aria-selected="false">
                            <?= lang('newOrderMaintenance.invoiceMX') ?>
                        </button>
                    </li>
                    ...
                    <li class="nav-item" role="presentation" hidden>
                        <button class="nav-link" id="documentosRelacionados-tab" data-toggle="tab" data-target="#documentosRelacionados" type="button" role="tab" aria-controls="documentosRelacionados" aria-selected="false">
                            <?= lang('newOrderMaintenance.relationDocuments') ?>
                        </button>
                    </li>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="generales" role="tabpanel" aria-labelledby="generales">
                        ...
                        <?= $this->include('julio101290\boilerplatemaintenance\Views\modulesOrderMaintenance/generalOrderMaintenance') ?>

                    </div>

                    <div class="tab-pane fade" id="otrosDatos" role="tabpanel" aria-labelledby="otrosDatos">

                        <?= $this->include('julio101290\boilerplatemaintenance\Views\modulesOrderMaintenance/otrosDatos') ?>

                    </div>

                    <div class="tab-pane fade" id="datosExtraVehiculo" role="tabpanel" aria-labelledby="datosExtraVehiculo">

                        <?= $this->include('julio101290\boilerplatemaintenance\Views\modulesOrderMaintenance/datosExtrasVehiculos') ?>
                    ...
                    <div class="tab-pane fade" id="facturaGlobal" role="tabpanel" aria-labelledby="facturaGlobal">
                        ...
                        <?= $this->include('julio101290\boilerplatemaintenance\Views\modulesOrderMaintenance/facturaGlobal') ?>
                    ...
                    <div class="tab-pane fade" id="facturacionMX" role="tabpanel" aria-labelledby="otrosDatos">
                        ...
                        <?= $this->include('julio101290\boilerplatemaintenance\Views\modulesOrderMaintenance/facturacionMX') ?>
                    ...
                    <div class="tab-pane fade" id="documentosRelacionados" role="tabpanel" aria-labelledby="documentosRelacionados">
                        ...
                        <?= $this->include('julio101290\boilerplatemaintenance\Views\modulesOrderMaintenance/documentosRelacionados') ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title"><?= lang('newOrderMaintenance.orderDetail') ?></h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                            <i class="fas fa-minus"></i>
                        </button>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box-body">
                                ...
                                <div class="box" style="overflow-y: scroll; height:250px;">
                                    ...
                                    ENCABEZADO
                                    ======================================-->
                                        <div class="col-1"> <?= lang('newOrderMaintenance.fields.row') ?> </div>
                                        <div class="d-none d-lg-table-cell col-1 "> <?= lang('newOrderMaintenance.fields.code') ?> </div>
                                        <div class="col-7"> <?= lang('newOrderMaintenance.fields.description') ?> </div>
                                        <div class="col-1"><?= lang('newOrderMaintenance.fields.amount') ?> </div>
                                        <div class="col-1"><?= lang('newOrderMaintenance.fields.price') ?> </div>
                                        <div class="col-1"><?= lang('newOrderMaintenance.fields.total') ?> </div>
                            ...
                            <div class="box-footer" style="
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-3" style="
                                         ...
                                         ">
                                        <label style="vertical-align: sub;margin-bottom: 0px;"><?= lang('newOrderMaintenance.subTotal') ?>:</label>
                                    </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-3" style="
                                        ...
                                        <label style="
                                               vertical-align: sub;
                                               "><?= lang('newOrderMaintenance.tax') ?>:</label>
                                    </div>
                                ...
                                <div class="row form-group grupoTotalRetencionIVA" hidden>
                                    ...
                                    <div class="col-3" style="
                                        ...
                                        <label style="
                                               vertical-align: sub;
                                               "><?= lang('newOrderMaintenance.VATWithholding') ?>:</label>
                                    </div>
                                ...
                                <div class="row form-group grupoTotalTasaExcenta" hidden>
                                    ...
                                    <div class="col-3" style="
                                        ...
                                        <label style="
                                               vertical-align: sub;
                                               "><?= lang('newOrderMaintenance.exemptRate') ?>:</label>
                                    </div>
                                ...
                                <div class="row form-group grupoTotalRetencionISR" hidden>
                                    ...
                                    <div class="col-3" style="
                                        ...
                                        <label style="
                                               vertical-align: sub;
                                               "><?= lang('newOrderMaintenance.ISRWithholding') ?>:</label>
                                    </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-3" style="
                                        ...
                                        <label style="
                                               vertical-align: sub;
                                               "><?= lang('newOrderMaintenance.total') ?>:</label>
                                    </div>
    ...
    <script>
        ...
        $(document).on('click', '#btnSaveChoferes', function (e) {
            ...
            if (idEmpresa == 0 || idEmpresa == null) {
                ...
                Toast.fire({
                    icon: 'error',
                    title: "<?= lang('newOrderMaintenance.selectCompanie') ?>"
                });
                return;
            }
            ...
            $.ajax({
                ...
                success: function (respuesta) {
                    if (respuesta.match(/Correctamente.*/)) {
                        ...
                        Toast.fire({
                            icon: 'success',
                            title: "<?= lang('newOrderMaintenance.driverSavedSucess') ?>"
                        });
...
// Initialize select2 storages
        $("#productOrder").select2({
            ajax: {
                ...
                processResults: function (response) {
                    ...
                    // ---------- AUTO-SELECCIÓN SI SOLO HAY 1 RESULTADO ----------
                    if (response.data.length === 1) {
                        let item = response.data[0];

                        // Crear opción si no existe
                        if ($("#productOrder option[value='" + item.id + "']").length === 0) {
                            let newOption = new Option(item.text, item.id, true, true);
                            $("#productOrder").append(newOption);
                        }

                        // Selección automática
                        $("#productOrder").val(item.id).trigger("change");

                        // Cerrar el dropdown de Select2 inmediatamente
                        $("#productOrder").select2('close');
                    }
        ...
        $(document).on('click', '#btnSaveVehiculos', function (e) {
            ...
            if (idTipoVehiculo == 0 || idTipoVehiculo == null) {
                ...
                Toast.fire({
                    icon: 'error',
                    title: "<?= lang('newOrderMaintenance.vehiclesNeedSelected') ?>"
                });
                return;
            }
            ...
            $.ajax({
                ...
                success: function (respuesta) {
                    if (respuesta.match(/Correctamente.*/)) {
                        ...
                        Toast.fire({
                            icon: 'success',
                            title: "<?= lang('newOrderMaintenance.vehiclesSavedSucess') ?>"
                        });
        ...
        function saveOrder() {
            ...
            if (custumerSell == 0 || custumerSell == "") {
                ...
                Toast.fire({
                    icon: 'error',
                    title: "<?= lang('newOrderMaintenance.selectCustumer') ?>"
                });
            ...
            if (idSucursal == 0 || idSucursal == "") {
                ...
                Toast.fire({
                    icon: 'error',
                    title: "<?= lang('newOrderMaintenance.selectBranchoffice') ?>"
                });
