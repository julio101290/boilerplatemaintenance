...
class orderMaintenance extends Migration {
    ...
    public function up() {
        ...
        $this->forge->addField([
            ...
            'idCustumer' => ['type' => 'bigint', 'constraint' => 20, 'null' => false],
            'idVendor' => ['type' => 'bigint', 'constraint' => 20, 'null' => false],
        ...
        $this->forge->createTable('ordermaintenance', true);
    }
